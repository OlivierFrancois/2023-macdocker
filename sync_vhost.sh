...
for project in $projects; do
    ...
    # Vérifier l'existence du fichier .conf dans le conteneur Docker
    if ! docker exec apache_php81-webserver ls "/etc/apache2/sites-enabled/${project_name}.conf" > /dev/null 2>&1; then
        ...
        # Activer le site puis redémarrer apache
